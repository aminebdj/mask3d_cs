...
def print_results(avgs,current_epoch,save_dir,split,task_ow):
    prev_known_avg = []
    prev_known_avg_25 = []
    prev_known_avg_50 = []
    curr_known_avg = []
...
def evaluate(current_epoch,config_general,
    ...
    # print
    print_results(avgs,current_epoch,config_general.save_dir,config_general.split,config_general.OW_task)
